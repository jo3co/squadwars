...
/// Functions to query SquadsRecords (as a Stream and as a Future).
...
Future<List<SquadsRecord>> querySquadsRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(SquadsRecord.collection, SquadsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
